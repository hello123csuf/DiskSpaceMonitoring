...
$list = "C:\DiskSpace\Servers.txt" #This accepts the argument you add to your scheduled task for the list of servers. i.e. list.txt
...
[decimal]$thresholdspace = 25


$user = "city\backupadmin"
$pass = cat "C:\DiskSpace\securepass.txt" | convertto-securestring 
...
$tableFragment= Get-WMIObject –credential $cred -ComputerName $computers Win32_LogicalDisk `
...
$HTMLmessage = @"
<center><font color=""black"" face=""Arial, Verdana"" size=""3"">
<u><b>Disk Space Storage Report for Cathedral City</b></u>

<br>This report was generated by Cathedral City MIS.
<br>

<style type=""text/css"">body{font: .8em ""Lucida Grande"", Tahoma, Arial, Helvetica, sans-serif;}
ol{margin:0;padding: 0 1.5em;}
table{color:#000000;background:#B7B0AE;border-collapse:collapse;width:647px;border:5px solid #900;}
thead{}
...
$HTMLmessage | out-file C:\inetpub\wwwroot\CCDiskSpaceReport\index.html

#Export report to CSV file (Disk Report)
#Export-csv -path "C:\Powershell\DiskReport_$logDate.htm" 
